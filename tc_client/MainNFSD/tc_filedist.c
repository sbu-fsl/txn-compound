...
int tc_dist(char *input_path, unsigned int block_size, unsigned int num_files,
...
*/
	...
	file_dist(num_ops, op_array, dist);
...
int main(int argc, char *argv[])
{
	...
	tc_dist(input_path, block_size, num_files, num_ops, ops_per_comp, dist, rw);
