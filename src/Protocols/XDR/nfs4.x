...
union nfs_cb_argop4 switch (unsigned argop) {
 case NFS4_OP_CB_GETATTR:	CB_GETATTR4args opcbgetattr;
 case NFS4_OP_CB_RECALL:	CB_RECALL4args	opcbrecall;
 case NFS4_OP_CB_ILLEGAL:	void;
};

union nfs_cb_resop4 switch (unsigned resop){
 case NFS4_OP_CB_GETATTR:	CB_GETATTR4res	opcbgetattr;
 case NFS4_OP_CB_RECALL:	CB_RECALL4res	opcbrecall;
 case NFS4_OP_CB_ILLEGAL:	CB_ILLEGAL4res	opcbillegal;
};
